class ModelCoursesController < ApplicationController
  ...
  def create
    ...
    most_common_transportation = selected_total_spot_items.group_by(&:transportation).max_by { |_, items| items.size }&.first
    @model_course.vehicle = most_common_transportation
